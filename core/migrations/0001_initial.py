# Generated by Django 3.1 on 2020-08-04 16:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='enter name of course here', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_name', models.CharField(help_text='enter your Surname here', max_length=20)),
                ('first_name', models.CharField(help_text='enter your name here', max_length=20)),
